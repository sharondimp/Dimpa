            ...
            {step === 0 && (
              <div>
                <div className="form-group">
                  ...
                  <input value={form.fullName} onChange={e => update('fullName', e.target.value)} placeholder="Sharon Adelaja" />
                </div>
                <div className="form-group">
            ...
            {step === 1 && (
              <div>
                <div className="form-group">
                  ...
                  <input value={form.storeName} onChange={e => { update('storeName', e.target.value); update('storeSlug', e.target.value.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')) }} placeholder="e.g. Dimp's Beauty Empire" />
                </div>
                <div className="form-group">
